...
app.post('/api/generate', async (req, res) => {
  ...
  try {
    ...
    const prompt = [
      `You are a professional travel copywriter. Write a single-paragraph Campspace listing in ${language}, max 650 characters, at least 100 characters. Make it SEO-optimized, easy to read, and free of AI clichés. Highlight setting, amenities, local attractions, sensory details, and host’s personal touch. Add a little bit of information based on the city the campspace is located in. MAX 650 CHARACTERS!`,
      `Country: ${country}`,
      `City: ${city}`,
      ``,
      `Draft: ${draft}`
